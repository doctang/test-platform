 ...
 *
 */
public class VellamoCPUTest extends PerfTest {
    ...
    public void test() throws UiObjectNotFoundException {
        ...
        UiObject cpu = cards.getChildByText(new UiSelector().resourceId(
                "com.quicinc.vellamo:id/card_topbar_text"), "多核");
        assertTrue("Unable to find cpu", cpu.exists());

        // 点击运行
        UiObject card3 = new UiObject(new UiSelector().className(
                RelativeLayout.class).index(3));
        ...
        UiObject progress = new UiObject(new UiSelector().resourceId(
                "com.quicinc.vellamo:id/runnerview_header_progress"));
        assertTrue("Unable to start test", progress.waitForExists(3000));
